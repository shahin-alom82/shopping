...
const PentPage = async () => {
      ...
      return (
            <Container className={"py-4"}>
                  <h1 className="lg:text-4xl text-xl font-semibold text-gray-800 tracking-wide">All Trending Pents Collection</h1>
